        ...
        <div class="col-9">
            <div class="card rounded-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        <?php $__currentLoopData = $tasklistColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-4">
                                <div class="card rounded-4">
                                    <div class="card-body">
                                        <div
                                                ...
                                                <div class="card task-box mb-3 rounded-4 shadow-lg"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div>
                                                            ...
                                                            <?php $__currentLoopData = $detil->where('id_tasks', $task->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php $__errorArgs = ['tasklistColumnName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2044170052-0', $__slots ?? [], get_defined_vars());
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <?php $__errorArgs = ['subTaskKeterangan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php $__errorArgs = ['subTaskStarted'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="status" class="form-select" wire:model='subTaskStatus'>
...
<?php /**PATH C:\laragon\www\epi-dasbor\resources\views\livewire\tasklist-detail.blade.php ENDPATH**/ ?>