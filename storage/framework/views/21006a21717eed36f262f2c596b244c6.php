    ...
    >
        <?php if($this->hasConfigurableAreaFor('toolbar-left-start')): ?>
            <div x-cloak x-show="!currentlyReorderingStatus" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                ...
                <?php echo $__env->make($this->getConfigurableAreaFor('toolbar-left-start'), $this->getParametersForConfigurableArea('toolbar-left-start'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        <?php endif; ?>

        <?php if($this->reorderIsEnabled()): ?>
...
<?php endif; ?>
        ...
        <?php if($this->searchIsEnabled() && $this->searchVisibilityIsEnabled()): ?>
...
<?php endif; ?>
        ...
        <?php if($this->filtersAreEnabled() && $this->filtersVisibilityIsEnabled() && $this->hasVisibleFilters()): ?>
...
<?php endif; ?>
        ...
        <?php if($this->hasActions && $this->showActionsInToolbar && $this->getActionsPosition == 'left'): ?>
...
<?php endif; ?>    
        ...
        <?php if($this->hasConfigurableAreaFor('toolbar-left-end')): ?>
            <div x-cloak x-show="!currentlyReorderingStatus" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                ...
                <?php echo $__env->make($this->getConfigurableAreaFor('toolbar-left-end'), $this->getParametersForConfigurableArea('toolbar-left-end'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        <?php endif; ?>
    </div>
    ...
    >
        ...
        <?php if($this->hasActions && $this->showActionsInToolbar && $this->getActionsPosition == 'right'): ?>
            <?php if (isset($component)) { $__componentOriginal59c796603a9fe3a5632766e1b08f5eca = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal59c796603a9fe3a5632766e1b08f5eca = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'livewire-tables::components.includes.actions','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('livewire-tables::includes.actions'); ?>
...
<?php endif; ?>
        ...
        <?php if($this->paginationIsEnabled() && $this->perPageVisibilityIsEnabled()): ?>
...
<?php endif; ?>
        ...
        <?php echo $__env->renderWhen($this->hasConfigurableAreaFor('toolbar-right-end'), $this->getConfigurableAreaFor('toolbar-right-end'), $this->getParametersForConfigurableArea('toolbar-right-end'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>
    </div>
</div>
<?php if(
...
<?php /**PATH C:\laragon\www\epi-dasbor\vendor\rappasoft\laravel-livewire-tables\resources\views\components\tools\toolbar.blade.php ENDPATH**/ ?>