                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" wire:model='namaAcara'
                                class="form-control <?php $__errorArgs = ['namaAcara'];
...
unset($__errorArgs, $__bag); ?>">
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['namaAcara'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tanggalMulai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tanggalSelesai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
