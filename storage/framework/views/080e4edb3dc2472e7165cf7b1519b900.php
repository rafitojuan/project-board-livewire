...
>
    ...
    >
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->reorderIsEnabled()): ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->filtersAreEnabled() && $this->filtersVisibilityIsEnabled() && $this->hasVisibleFilters()): ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->paginationIsEnabled() && $this->perPageVisibilityIsEnabled()): ?>
