                ...
                <div class="card rounded-4">
                    <div class="card-body">
                        ...
                        <div class="task-list" data-column-id="<?php echo e($column->id); ?>" x-data="{ dropzone: null }"
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $column->tasklists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tasklist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="card task-box mb-3 rounded-4 <?php echo e($tasklist->status_id <= 1 ? 'undraggable' : ''); ?>"
                                    ...
                                    style="cursor: <?php echo e($tasklist->status_id <= 1 ? 'not-allowed' : 'grab'); ?>; border: 4px solid <?php echo e(now() > $tasklist->end_at ? '#F46A6A' : 'transparent'); ?>;">
                                    <div class="card-body">
                                        <div class="dropdown float-end">
                                        ...
                                        <div class="float-end ml-2">
                                            <?php if($tasklist->user->role->name): ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if($tasklist->user->division_id): ?>
                                                <span class="badge rounded-pill font-size-12"
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php $__errorArgs = ['newTasklistCompany'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php $__errorArgs = ['newTasklistName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="contract"
                            ...
                            <?php $__errorArgs = ['newTasklistContract'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php $__errorArgs = ['tasklistPengadaan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php $__errorArgs = ['contractSignDate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    id="start_date">
                                <?php $__errorArgs = ['newTasklistStartDate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    id="end_date">
                                <?php $__errorArgs = ['newTasklistEndDate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
