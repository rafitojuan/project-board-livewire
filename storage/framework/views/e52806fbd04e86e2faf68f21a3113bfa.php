    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo e(route('kanban.index')); ?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('build/images/logo_project_board.png')); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                ...
                <a href="<?php echo e(route('kanban.index')); ?>" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('build/images/logo_project_board.png')); ?>" alt=""
                            height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('build/images/logo_project_board.png')); ?>" alt="" height="55"
...
[$__name, $__params] = $__split('tombol-notif', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-3130557131-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\laragon\www\epi-dasbor\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>